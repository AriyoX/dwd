  ...
  return (
    <main className="page-shell" id="main-content">
      ...
      <article className="legal-copy">
        ...
        <h1>Terms of use</h1>
        <p>
          Drink with Desire is for adults tracking entries they choose to record during a shared night. It
          is not a drinking game, competition, medical device, BAC calculator, sobriety detector, or
          driving-safety tool.
        </p>
        <h2>No safety determination</h2>
        <p>
          Counts and alcohol equivalents are approximate. Never use Drink with Desire to decide whether
          anyone can drive, whether someone is sober, or whether emergency care is needed.
        </p>
        <h2>Emergencies</h2>
        <p>
